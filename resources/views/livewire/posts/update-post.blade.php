<div class="wrapper w-full md:max-w-5xl mx-auto pt-20 px-4">
    ...
    <form wire:submit="save" class="bg-gray-100 shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-6">
            <div>
                <select wire:model.change="form.category_id" title="label for the select" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
